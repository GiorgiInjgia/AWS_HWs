...
parser.add_argument("-fp",
                    "--file_path",
                    type=str,
                    help="file path for uploading object ",
                    default=None)
...
def main():
    ...
    if args.bucket_name:
        ...
        if args.upload_file_object == "True" and args.file_path:
            upload_file_obj(s3_client, args.bucket_name, args.file_path)
            print("file object uploaded")

        if args.upload_file == "True" and args.file_path:
            upload_file(s3_client, args.bucket_name, args.file_path)
            print("file uploaded")

        if args.upload_file_put == "True" and args.file_path:
            upload_file_put(s3_client, args.bucket_name, args.file_path)
            print("put file is finished")

        if args.multiple_upload == "True" and args.file_path:
            multipart_upload(s3_client, args.bucket_name, args.file_path)
            print("big file uploading is finished")
